...
На текущем этапе реализованы базовые API-тесты, contract checks для `/brands` и `/products`, а также первый слой переиспользуемых assertion/helper-функций.
...
В проекте появился набор универсальных проверок и contract-helper'ов.
